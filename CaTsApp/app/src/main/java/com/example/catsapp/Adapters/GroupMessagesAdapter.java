...
import com.example.catsapp.databinding.ItemReceiveGroupBinding;
import com.example.catsapp.databinding.ItemSentGroupBinding;
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener()
            {
                ...
                public boolean onLongClick(View v)
                {
                    ...
                    binding.delete.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            FirebaseDatabase.getInstance().getReference().child("public").child(message.getMessageId()).setValue(null);
