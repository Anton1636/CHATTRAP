...
import com.example.catsapp.Secvice.AudioService;
...
public class ChatsAdapder extends RecyclerView.Adapter<ChatsAdapder.ViewHolder>
{
   ...
   // private FirebaseUser firebaseUser;
    ...
    public ChatsAdapder(List<Message> list, Context context)
    {
        this.list = list;
        ...
        void bind(final Message chats)
        {
            ...
            switch (chats.getType()){
                case "TEXT" :
                    ...
                    textMessage.setText(chats.getMessage());
